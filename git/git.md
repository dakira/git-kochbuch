...
- [Undo](#undo)
    ...
    - [Ungewollte commits auf master in eigenen Branch schieben](#ungewollte-commits-auf-master-in-eigenen-branch-schieben)
...
### Ungewollte commits auf master in eigenen Branch schieben

Manchmal hat man aus Versehen etwas auf dem `master` Branch commited, was eigentlich in einem Feature-Branch hätte landen sollen. Naïv könnte man annehmen man erstellt einfach ein Branch ausgehend von master und löscht danach die commits auf master (`git reset --hard`).
